...
<!--**Feb. 3, 2025**: We released **two papers** on ArXiv: (1) [DMin: Scalable Training Data Influence Estimation for Diffusion Models](https://arxiv.org/abs/2412.08637): The first **highly scalable influence estimation method** for stable diffusion models with billions of parameters, capable of identifying the most influential training samples for a given test generation within seconds. (2) [Online Gradient Boosting Decision Tree: In-Place Updates for Efficient Adding/Deleting Data](https://arxiv.org/abs/2502.01634): The first work to introduce an in-place unified incremental and decremental learning approach for GBDT, enabling **real-time addition and deletion** of data within the model.<br />--!>
